...
test('test load Community from api', async () => {
    ...
    try {
        ...
        city1 = ctrl.get('1');
        expect(city1.name).toBe('City1');
        city2 = ctrl.get('2');
        expect(city2.name).toBe('City2');
...
test('does that updatePopulation function work', async () => {
    ...
    // await ctrl.getCommunity();
    // city = ctrl.get('1');
    // expect(city.balance).toBe(10);

    // expect(ctrl.total()).toBe(40);
});
