...
def test_read_invoice():
    ...
    assert d['Invoices'][1] == {'invoice_no': 1, 'customer_id': 1, 'invoice_date': '2020-03-02', 'payment_method': 'Cash', 'total_price': 470, None: None}
    
    assert d['Invoice Line Items'][1] == {'line_id': 1, 'invoice_no': 1, 'product_id': 130, 'quantity': 13, 'price': 260, 'invoice_date': '2020-03-02', None: None}
